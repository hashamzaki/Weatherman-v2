...
if __name__ == '__main__':
    ...
    if sys.argv[1] == '-e':
        ...
        utils.print_highest_temperature(max_temperature_data['max_temperature'], max_temperature_data['month'],
                                        max_temperature_data['day'])
        min_temperature_data = Calculator.find_lowest_in_year(calculation_instance, year)
        utils.print_lowest_temperature(min_temperature_data['min_temperature'], min_temperature_data['month'],
                                       min_temperature_data['day'])
        max_humidity_data = Calculator.find_most_humid_in_year(calculation_instance, year)
        utils.print_most_humid_day(max_humidity_data['max_humidity'], max_humidity_data['month'],
